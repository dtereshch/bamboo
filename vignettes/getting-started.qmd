...
please visit the package web-book: <https://dtereshch.github.io/bambook/>
...
devtools::install_github("dtereshch/bamboo")
```
...
You can also visualise these patterns with a heatmap using `plot_patterns()`.
...
`plot_heterogeneity()` visualises the distribution of a numeric variable across groups. We use `select = "sales"` to look at `sales`, and the function automatically uses the entity and time variables as groups because panel has panel attributes.
